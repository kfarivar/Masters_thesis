...
if __name__ == '__main__':
    ...
    # data prepare (kiya modified tha data path)
    
    if dataset == 'cifar10':
        train_data = torchvision.datasets.CIFAR10(root='/home/farivar/adversarial-components/data', train=True, \
                                                  transform=utils.CifarPairTransform(train_transform = True), download=True)
        memory_data = torchvision.datasets.CIFAR10(root='/home/farivar/adversarial-components/data', train=True, \
                                                  transform=utils.CifarPairTransform(train_transform = False), download=True)
        test_data = torchvision.datasets.CIFAR10(root='/home/farivar/adversarial-components/data', train=False, \
                                                  transform=utils.CifarPairTransform(train_transform = False), download=True)
    elif dataset == 'stl10':
